...
//        ]
        guestList = [
            Pengunjung(nama:"Pengunjung1",kesabaranSecurity: 3,ImageName: "guest-1"),
            Pengunjung(nama:"Pengunjung2",kesabaranSecurity: 2,ImageName: "guest-2"),
            Pengunjung(nama:"Pengunjung3",kesabaranSecurity: 2,ImageName: "guest-3"),
            Pengunjung(nama:"Pengunjung4",kesabaranSecurity: 3,ImageName: "guest-4"),
            Pengunjung(nama:"Pengunjung5",kesabaranSecurity: 4,ImageName: "guest-5"),
            Pengunjung(nama:"Pengunjung6",kesabaranSecurity: 3,ImageName: "guest-6"),
            Pengunjung(nama:"Pengunjung7",kesabaranSecurity: 2,ImageName: "guest-7"),
            Pengunjung(nama:"Pengunjung8",kesabaranSecurity: 2,ImageName: "guest-8"),
        ]
    }
}
